...
import pytest
from rhp_analyzer.ingestion.promoter_extractor import PromoterDossier, PromoterExtractor
...
def sample_state():
    ...
    return {
        "sections": {
            ...
            "Capital Structure": {"content": "", "tables": []},
        },
        "ipo_details": {"price_band_cap": 100, "shares_post_issue": 10000000},
    }
...
class TestPromoterExtractor:
    ...
    def test_calculate_skin_in_game(self, promoter_extractor):
        ...
        value = promoter_extractor.calculate_skin_in_game(dossier, cap_price, total_shares)
    ...
    def test_merge_promoter_data(self, promoter_extractor, sample_state):
        ...
        directorships = {"John Doe": ["ABC Ltd", "XYZ Corp"]}

        shareholding = {"John Doe": {"pre": 30.0, "post": 25.0}}
...
class TestPromoterDossier:
    ...
    def test_dossier_creation(self):
        ...
        dossier = PromoterDossier(name="John Doe", din="12345678", age=45)
    ...
    def test_dossier_with_directorships(self):
        ...
        dossier = PromoterDossier(name="John Doe", other_directorships=["ABC Ltd", "XYZ Corp", "PQR Inc"])
    ...
    def test_dossier_litigation_summary(self):
        ...
        dossier = PromoterDossier(
            name="John Doe", criminal_cases=2, civil_cases=5, regulatory_actions=1, total_litigation_amount=10.5
        )
...
class TestEdgeCases:
    ...
    def test_malformed_content(self, promoter_extractor):
        ...
        state = {"sections": {"Our Promoters": {"content": "Random text without proper structure", "tables": []}}}
    ...
    def test_missing_ipo_details(self, promoter_extractor):
        ...
        state = {"sections": {"Our Promoters": {"content": "Mr. John Doe, DIN: 12345678", "tables": []}}}
    ...
    def test_full_extraction_workflow(self, promoter_extractor):
        ...
        state = {
            "sections": {
                ...
                "Capital Structure": {"content": "Shareholding pattern disclosed separately", "tables": []},
            },
            "ipo_details": {"price_band_cap": 150, "shares_post_issue": 50000000},
        }
